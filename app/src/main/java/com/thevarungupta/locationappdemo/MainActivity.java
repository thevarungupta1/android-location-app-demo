package com.thevarungupta.locationappdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        textViewLatLong = findViewById(R.id.text_lat_long);
        textViewAddress = findViewById(R.id.text_address);
        progressBar = findViewById(R.id.progress_bar);

        buttonGetLocation = findViewById(R.id.button_current_location);
                ...
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if(locationRequest !=null && locationResult.getLocations().size() > 0){
                            ...
                            featchAddressFromLatLong(location);
                        }else{
    ...
    private void featchAddressFromLatLong(Location location){
